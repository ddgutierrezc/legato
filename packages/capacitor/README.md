...
|---|---|---|
| Android | Maven Central coordinate `dev.dgutierrez:legato-android-core:0.1.4` | `native-artifacts.json` |
| iOS | SwiftPM remote package `LegatoCore` at `https://github.com/ddgutierrezc/legato-ios-core.git` pinned with `exact(0.1.3)` | `native-artifacts.json` |
