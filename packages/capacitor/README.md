...
|---|---|---|
| Android | Maven Central coordinate `dev.dgutierrez:legato-android-core:1.1.0` | `native-artifacts.json` |
| iOS | SwiftPM remote package `LegatoCore` at `https://github.com/ddgutierrezc/legato-ios-core.git` pinned with `exact(1.1.0)` | `native-artifacts.json` |
